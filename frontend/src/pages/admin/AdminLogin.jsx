...
const AdminLogin = () => {
  ...
  const {axios,loading,setLoading,navigate,setAdmin}=useContext(AppContext);
  ...
  return (
    <div className='py-12 flex items-center justify-center'>
      ...
      <form onSubmit={handleSubmit} className='py-12 w-full sm:w-[350px] text-center border border-zinc-300/60 dark:border-zinc-700 rounded-2xl px-8 bg-white dark:bg-zinc-900 '> 
